...
@section('content')
    ...
    <a href="{{ route('admin.settings.edit-details') }}" class="btn btn-secondary btn-block mb-3">Edit Details</a>
    <a href="{{ route('admin.settings.edit-password') }}" class="btn btn-secondary btn-block">Change Password</a>
