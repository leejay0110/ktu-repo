...
@section('nav')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">
                <a href="{{ route('user.papers.show', $paper->id) }}">{{ $paper->course_title }}</a>
            </li>
...
@section('content')
    ...
    <h1 class="display-4">Edit Past Exam Paper</h1>

    <br>

    <form action="{{ route('user.papers.update', $paper->id) }}" method="post">
